...
var ImageParticles = {
    ...
    initialize: function(canvas_id, imageData,densityPara=9,produceDistancePara=8,baseRadiusPara=1,maxLineThicknessPara=1,reactionSensitivityPara=4,lineThicknessPara=2) {
